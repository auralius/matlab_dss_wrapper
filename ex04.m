...
for k = 1: length(dss.hires_states)
    set(p1, "XData", l*sin(dss.hires_states(1,k))+dss.hires_states(3,k));
    set(p1, "YData", -l*cos(dss.hires_states(1,k)));
    set(p2, "XData", [dss.hires_states(3,k) ...
        l*sin(dss.hires_states(1,k)) + dss.hires_states(3,k)]);
    set(p2, "YData", [0 -l*cos(dss.hires_states(1,k))]);
